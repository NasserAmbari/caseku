            ...
            <li class="nav-item menu-open">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item active">
                        <a href="{{ route('listPhoneBrand') }}" class="nav-link active">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">List Phone</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-xl-4 offset-xl-7 ">
                        <form style="margin-bottom:0!important;" action="{{ route('listPhoneBrand') }}">
                ...
                <table class="table table-head-fixed text-nowrap table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width:20rem;">@sortablelink('phone_brand','Phone Brand')</th>
                            <th style="text-align:end;">Action</th>
                        </tr>
                    </thead>

                    <tbody>
                        @foreach($phone_brands as $data)
                        <tr>
                            <td>{{ $data->id }}</td>
                            <td>{{ $data->phone_brand }}</td>
                            <td style="text-align:end;">
                                <a class="updateData" data-target="#updateModal" data-toggle="modal"
                                    data-attr="{{ route('getEditPhoneBrandData', ['id' => $data->id]) }}"><i
            ...
            {{ $phone_brands->appends(\Request::except('page'))->render() }}

        </div>
    </div>
</div>

<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createCaseType"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="createCaseType">Add New Brand Phone</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('storePhoneBrandData') }}" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="createbrandphone">Brand Phone</label>
                        <input type="input" class="form-control" id="createbrandphone" name="brandphone">
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnCreateBrandPhoneType">Save</button>
                </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updatePhoneBrandData"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="updatePhoneBrandData">Update Phone Brand</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('updatePhoneBrandType') }}" method="POST">
                @method('PATCH')
                <div class="modal-body">

                    <div class="form-group">
                        <label for="phonebrand">Phone Brand</label>
                        <input type="input" class="form-control" id="updatephonebrand" name="phonebrand">
                    </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteBrandPhone"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="deleteBrandPhone">Delete Case Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('deletePhoneBrandData') }}" method="POST">
                @method('DELETE')
...
<script>
    ...
    const phoneBrand = document.querySelector('#updatephonebrand');
    ...
    allUpdateButton.forEach((elm, idx) => {
        elm.addEventListener('click', () => {
            ...
            getEditData(url, (result) => {
                updatephonebrand.value = result.phone_brand;
                id.value = result.id;
            });
        });
    });
