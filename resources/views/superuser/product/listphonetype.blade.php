        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item active">
                        <a href="{{ route('listPhoneType') }}" class="nav-link active">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-xl-4 offset-xl-7 ">
                        <form style="margin-bottom:0!important;" action="{{ route('listPhoneType') }}">
                ...
                <table class="table table-head-fixed text-nowrap table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width:20rem;">@sortablelink('phone_type','Phone Type')</th>
                        ...
                        <tr>
                            ...
                            <td style="text-align:end;">
                                <a class="updateData" data-target="#updateModal" data-toggle="modal"
                                    data-attr="{{ route('getEditPhoneTypeData', ['id' => $data->id]) }}"><i
            ...
            {{ $phone_types->appends(\Request::except('page'))->render() }}
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="createModal">Add New Phone Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('storePhoneTypeData') }}" method="POST">
                <div class="modal-body" style="overflow: visible;">
                    <div class="form-group">
                        <label for="createbrandphone">Type Phone</label>
                        <input type="input" class="form-control" id="createbrandphone" name="typephone">
                    </div>

                    <div class="form-group">
                        <label for="createbrandphone">Brand Phone</label>
                        <select class="selectpicker" name="brandid" data-live-search="true" data-size="4"
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="updateModal">Update Phone Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('updatePhoneTypeData') }}" method="POST">
                @method('PATCH')
                <div class="modal-body" style="overflow: visible;">

                    <div class="form-group">
                        <label for="phonebrand">Phone Brand</label>
                        <input type="input" class="form-control" id="updatephonetype" name="phonetype">
                    </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteBrandPhone"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('deletePhoneTypeData') }}" method="POST">
                @method('DELETE')
...
<script>
    ...
    const phoneType = document.querySelector('#updatephonetype');
    ...
    allUpdateButton.forEach((elm, idx) => {
        elm.addEventListener('click', () => {
            ...
            getEditData(url, (result) => {
                phoneType.value = result.phone_type;
                $('select[name=brandid]').val(result.phone_brand_id);
