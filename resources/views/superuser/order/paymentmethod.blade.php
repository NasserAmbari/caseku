        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('listPaymentMethod') }}" class="nav-link active">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-xl-4 offset-xl-7 ">
                        <form style="margin-bottom:0!important;" action="{{ route('listPaymentMethod') }}">
                ...
                <table class="table table-head-fixed text-nowrap table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width:20rem;">@sortablelink('payment_method','Payment Method')</th>
                        ...
                        <tr>
                            ...
                            <td style="text-align:end;">
                                <a class="updateData" data-target="#updateModal" data-toggle="modal"
                                    data-attr="{{ route('getEditPaymentMethodData', ['id' => $data->id]) }}"><i
            ...
            {{ $payment_method->appends(\Request::except('page'))->render() }}

        </div>
    </div>
</div>

<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createNewData"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="createNewData">Add New Payment Method</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('storePaymentMethodData') }}" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="createNewPaymentData">Payment Method</label>
                        <input type="input" class="form-control" id="createNewPaymentData" name="paymentmethod">
                    </div>
                </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updatePaymentMethodData"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="updatePaymentMethodData">Update Payment Method</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('updatePaymentMethodData') }}" method="POST">
                @method('PATCH')
                <div class="modal-body">

                    <div class="form-group">
                        <label for="updateNewPaymentMethod">Update Payment Method</label>
                        <input type="input" class="form-control" id="updateNewPaymentMethod" name="paymentmethod">
                    </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="delete"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('deletePaymentMethodData') }}" method="POST">
                @method('DELETE')
...
<script>
    ...
    const paymentMethod = document.querySelector('#updateNewPaymentMethod');
